          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-2">
              ...
              {!social.instagram && !social.twitter && !social.facebook && (
                <>
                  <a href="#" className="p-2 rounded-lg bg-brand-100 hover:bg-brand-200 text-brand-600 transition-colors"><Instagram className="h-4 w-4" /></a>
                  <a href="#" className="p-2 rounded-lg bg-brand-100 hover:bg-brand-200 text-brand-600 transition-colors"><Twitter className="h-4 w-4" /></a>
                  <a href="#" className="p-2 rounded-lg bg-brand-100 hover:bg-brand-200 text-brand-600 transition-colors"><Facebook className="h-4 w-4" /></a>
                </>
              )}
            </div>
          </div>
