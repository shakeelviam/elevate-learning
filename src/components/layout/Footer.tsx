            ...
            <div className="flex gap-2">
              {social.instagram && (
                <a href={social.instagram} target="_blank" rel="noopener noreferrer"
                  className="p-2 rounded-lg bg-gray-800 hover:bg-brand-600 transition-colors">
              ...
              {!social.instagram && !social.twitter && !social.facebook && (
                <>
                  <a href="#" className="p-2 rounded-lg bg-gray-800 hover:bg-brand-600 transition-colors"><Instagram className="h-4 w-4" /></a>
                  <a href="#" className="p-2 rounded-lg bg-gray-800 hover:bg-brand-600 transition-colors"><Twitter className="h-4 w-4" /></a>
                  <a href="#" className="p-2 rounded-lg bg-gray-800 hover:bg-brand-600 transition-colors"><Facebook className="h-4 w-4" /></a>
                </>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href={`tel:${phone}`} className="text-sm text-gray-400 hover:text-brand-400 transition-colors">
                  {phone}
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-4 w-4 text-brand-400 flex-shrink-0" />
                <a href={`mailto:${email}`} className="text-sm text-gray-400 hover:text-brand-400 transition-colors">
                  {email}
                </a>
              </li>
            </ul>
