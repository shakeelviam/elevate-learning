...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      locale === 'ar'
        ? 'الشروط والأحكام لمعهد إليفيت ليرنينج'
...
Refund requests must be submitted in writing to info@elevate-learning.com.`,
    },
    {
...
**Elevate Learning**
Kuwait City, Kuwait
Email: info@elevate-learning.com
Phone: +965 2222 3333`,
    },
  ],
}
  ...
  sections: [
    {
      ...
      body: 'باستخدام موقع إليفيت ليرنينج وخدماتها، توافق على الالتزام بهذه الشروط والأحكام. إذا لم توافق، يرجى عدم استخدام خدماتنا. تسري هذه الشروط على جميع الزوار والمستخدمين والمشاركين في الدورات.',
    },
    {
      heading: '2. وصف الخدمات',
      body: 'تقدم إليفيت ليرنينج دورات تدريب لغوي والتحضير للامتحانات في الكويت. تشمل خدماتنا الدورات الحضورية والإلكترونية، إدارة تسجيل الدورات، ولوحة تحكم الطالب. يُخطط لتسليم الدورات الإلكترونية في مرحلة مستقبلية.',
    },
    {
...
• في حال إلغاء إليفيت ليرنينج للدورة: استرداد كامل أو رصيد لدورة مستقبلية.
يجب تقديم طلبات الاسترداد كتابياً إلى info@elevate-learning.com`,
    },
    {
      heading: '7. الحضور وقواعد السلوك',
      body: 'يُتوقع من الطلاب الحضور في الوقت المحدد واحترام المدربين والزملاء والامتناع عن أي سلوك مزعج. تحتفظ إليفيت ليرنينج بالحق في إخراج أي طالب من الدورة دون استرداد في حالات سوء السلوك الجسيم.',
    },
    {
      heading: '8. الملكية الفكرية',
      body: 'جميع مواد الدورات والمحتوى والموارد التي تقدمها إليفيت ليرنينج محمية بحقوق الملكية الفكرية. يمكنك استخدامها للتعلم الشخصي فقط. يُحظر نسخ أو توزيع أو الاستخدام التجاري لأي مواد دون موافقتنا الخطية.',
    },
    {
      heading: '9. تحديد المسؤولية',
      body: 'لن تكون إليفيت ليرنينج مسؤولة عن أي أضرار غير مباشرة أو عرضية أو خاصة أو تبعية ناجمة عن استخدامك لخدماتنا. لا تتجاوز مسؤوليتنا القصوى المبلغ المدفوع مقابل الدورة المعنية.',
    },
    {
      heading: '10. الخصوصية',
...
**إليفيت ليرنينج**
مدينة الكويت، الكويت
البريد الإلكتروني: info@elevate-learning.com
